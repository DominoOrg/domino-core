...
pub fn each_tile_used_once_bound(vars: &Variables) -> Vec<String> {
    ...
    for variables in vars.by_tile.values() {
        ...
        // Check and extend only if the tile is single
        // This enforces that in a sequence a tile with numbers a,b
        // do not appears in any other position as b,a
